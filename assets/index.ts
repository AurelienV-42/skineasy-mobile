const assets = {
  bubbleBackground: require('./background/bubbleBackground.png'),
  bubbleHeader: require('./background/bubbleHeader.png'),
  ChocolatesBold: require('./fonts/ChocolatesBold.otf'),
  ChocolatesMedium: require('./fonts/ChocolatesMedium.otf'),
  ChocolatesSemibold: require('./fonts/ChocolatesSemibold.otf'),
  ChocolatesRegular: require('./fonts/ChocolatesRegular.otf'),
  bubbleRoutine: require('./home/bubbleRoutine.png'),
