...
export function useCreateMeal() {
  ...
  return useMutation({
    mutationFn: (dto: CreateMealEntryDto) => mealApi.createMeal(dto),
...
export function useUploadMealPhoto() {
  return useMutation({
    mutationFn: ({ uri, date }: { uri: string; date: string }) =>
      mealApi.uploadMealPhoto(uri, date),
...
export function useDeleteMeal() {
  ...
  return useMutation({
    mutationFn: ({ id }: { id: string; date: string }) => mealApi.deleteMeal(id),
