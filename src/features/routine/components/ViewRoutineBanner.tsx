...
interface ViewRoutineBannerProps {
  onPress: () => void
}

export function ViewRoutineBanner({ onPress }: ViewRoutineBannerProps) {
        ...
        <View className="flex-row items-center justify-between">
          <View className="flex-row items-center flex-1">
            ...
            <View className="flex-1">
              <Text className="text-lg font-bold text-white mb-1">{t('routine.readyTitle')}</Text>
              <Text className="text-sm text-white/90">{t('routine.viewRoutine')}</Text>
            </View>
          </View>
